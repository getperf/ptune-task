  ...
  noteSummary: {
    system: {
      lines: [
        ...
        "The `summary` field must be a string[] of concise factual lines with about 5-8 items.",
        "The `summary_segments_markdown` field must be a Markdown string.",
        "summary_segments_markdown must use only `##` headings and `-` bullets.",
        "The `summary_segments_markdown` field should contain 4-8 segments, and each segment should have 1-4 bullets.",
