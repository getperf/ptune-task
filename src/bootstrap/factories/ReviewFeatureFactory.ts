...
import { NoteReviewCompletionEventHookService } from "../../infrastructure/event_hook/NoteReviewCompletionEventHookService";
...
export class ReviewFeatureFactory {
  ...
  createNoteReviewFeature(): NoteReviewFeature {
    return new NoteReviewFeature(
      ...
      new NoteReviewCompletionEventHookService(),
    );
  }
}
